...
*/
inline bool isInvalidData(float value)
{
...
*/
inline bool isInvalidData(float value1, float value2)
{
...
public:
  ...
  // non-virtual methods:
  float length() const { return qSqrt(mX*mX+mY*mY); }
  ...
  float dot(const QCPVector2D &vec) const { return mX*vec.mX+mY*vec.mY; }
  float distanceSquaredToLine(const QCPVector2D &start, const QCPVector2D &end) const;
  float distanceSquaredToLine(const QLineF &line) const;
  float distanceToStraightLine(const QCPVector2D &base, const QCPVector2D &direction) const;
  
  QCPVector2D &operator*=(float factor);
  QCPVector2D &operator/=(float divisor);
...
private:
  ...
  friend inline const QCPVector2D operator*(float factor, const QCPVector2D &vec);
  friend inline const QCPVector2D operator*(const QCPVector2D &vec, float factor);
  friend inline const QCPVector2D operator/(const QCPVector2D &vec, float divisor);
...
inline const QCPVector2D operator*(float factor, const QCPVector2D &vec) { return QCPVector2D(vec.mX*factor, vec.mY*factor); }
inline const QCPVector2D operator*(const QCPVector2D &vec, float factor) { return QCPVector2D(vec.mX*factor, vec.mY*factor); }
inline const QCPVector2D operator/(const QCPVector2D &vec, float divisor) { return QCPVector2D(vec.mX/divisor, vec.mY/divisor); }
...
{
public:
  explicit QCPAbstractPaintBuffer(const QSize &size, float devicePixelRatio);
  virtual ~QCPAbstractPaintBuffer();
  
  // getters:
  QSize size() const { return mSize; }
  bool invalidated() const { return mInvalidated; }
  float devicePixelRatio() const { return mDevicePixelRatio; }
...
{
public:
  explicit QCPPaintBufferPixmap(const QSize &size, float devicePixelRatio);
...
{
public:
  explicit QCPPaintBufferGlPbuffer(const QSize &size, float devicePixelRatio, int multisamples);
...
{
public:
  explicit QCPPaintBufferGlFbo(const QSize &size, float devicePixelRatio, QWeakPointer<QOpenGLContext> glContext, QWeakPointer<QOpenGLPaintDevice> glPaintDevice);
...
public:
  ...
  // introduced virtual methods:
  virtual float selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=0) const;
...
public:
  ...
  QCPRange();
  QCPRange(float lower, float upper);
  ...
  QCPRange &operator+=(const float& value) { lower+=value; upper+=value; return *this; }
  QCPRange &operator-=(const float& value) { lower-=value; upper-=value; return *this; }
  QCPRange &operator*=(const float& value) { lower*=value; upper*=value; return *this; }
  QCPRange &operator/=(const float& value) { lower/=value; upper/=value; return *this; }
  friend inline const QCPRange operator+(const QCPRange&, float);
  friend inline const QCPRange operator+(float, const QCPRange&);
  friend inline const QCPRange operator-(const QCPRange& range, float value);
  friend inline const QCPRange operator*(const QCPRange& range, float value);
  friend inline const QCPRange operator*(float value, const QCPRange& range);
  friend inline const QCPRange operator/(const QCPRange& range, float value);
  
  float size() const { return upper-lower; }
  float center() const { return (upper+lower)*0.5; }
  void normalize() { if (lower > upper) qSwap(lower, upper); }
  void expand(const QCPRange &otherRange);
  void expand(float includeCoord);
  QCPRange expanded(const QCPRange &otherRange) const;
  QCPRange expanded(float includeCoord) const;
  QCPRange bounded(float lowerBound, float upperBound) const;
  QCPRange sanitizedForLogScale() const;
  QCPRange sanitizedForLinScale() const;
  bool contains(float value) const { return value >= lower && value <= upper; }
  
  static bool validRange(float lower, float upper);
  static bool validRange(const QCPRange &range);
  static const float minRange;
...
*/
inline const QCPRange operator+(const QCPRange& range, float value)
{
...
/*!
  Adds \a value to both boundaries of the range.
*/
inline const QCPRange operator+(float value, const QCPRange& range)
{
  QCPRange result(range);
  result += value;
  return result;
...
public:
  ...
  */
  ...
  // reimplemented virtual methods:
  virtual float selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=0) const Q_DECL_OVERRIDE;
...
protected:
  ...
  QVector<int> getSectionSizes(QVector<int> maxSizes, QVector<int> minSizes, QVector<float> stretchFactors, int totalSize) const;
...
class QCP_LIB_DECL QCPLayoutGrid : public QCPLayout
{
  ...
  Q_PROPERTY(QList<float> columnStretchFactors READ columnStretchFactors WRITE setColumnStretchFactors)
  Q_PROPERTY(QList<float> rowStretchFactors READ rowStretchFactors WRITE setRowStretchFactors)
...
public:
  ...
  */
  ...
  QList<float> columnStretchFactors() const { return mColumnStretchFactors; }
  QList<float> rowStretchFactors() const { return mRowStretchFactors; }
  ...
  // setters:
  void setColumnStretchFactor(int column, float factor);
  void setColumnStretchFactors(const QList<float> &factors);
  void setRowStretchFactor(int row, float factor);
  void setRowStretchFactors(const QList<float> &factors);
...
protected:
  ...
  QList<float> mColumnStretchFactors;
  QList<float> mRowStretchFactors;
...
public:
  ...
  */
  ...
  QCPLineEnding();
  QCPLineEnding(EndingStyle style, float width=8, float length=10, bool inverted=false);
...
public:
  ...
  */
  ...
  float tickOrigin() const { return mTickOrigin; }
  
  // setters:
  void setTickStepStrategy(TickStepStrategy strategy);
  void setTickCount(int count);
  void setTickOrigin(float origin);
  
  // introduced virtual methods:
  virtual void generate(const QCPRange &range, const QLocale &locale, QChar formatChar, int precision, QVector<float> &ticks, QVector<float> *subTicks, QVector<QString> *tickLabels);
...
protected:
  ...
  // introduced virtual methods:
  virtual float getTickStep(const QCPRange &range);
  virtual int getSubTickCount(float tickStep);
  virtual QString getTickLabel(float tick, const QLocale &locale, QChar formatChar, int precision);
  virtual QVector<float> createTickVector(float tickStep, const QCPRange &range);
  virtual QVector<float> createSubTickVector(int subTickCount, const QVector<float> &ticks);
  virtual QVector<QString> createLabelVector(const QVector<float> &ticks, const QLocale &locale, QChar formatChar, int precision);
  
  // non-virtual methods:
  void trimTicks(const QCPRange &range, QVector<float> &ticks, bool keepOneOutlier) const;
  float pickClosest(float target, const QVector<float> &candidates) const;
  float getMantissa(float input, float *magnitude=0) const;
  float cleanMantissa(float input) const;
};
...
public:
  ...
  void setTickOrigin(float origin); // hides base class method but calls baseclass implementation ("using" throws off IDEs and doxygen)
  void setTickOrigin(const QDateTime &origin);
  
  // static methods:
  static QDateTime keyToDateTime(float key);
  static float dateTimeToKey(const QDateTime dateTime);
  static float dateTimeToKey(const QDate date);
...
protected:
  ...
  // reimplemented virtual methods:
  virtual float getTickStep(const QCPRange &range) Q_DECL_OVERRIDE;
  virtual int getSubTickCount(float tickStep) Q_DECL_OVERRIDE;
  virtual QString getTickLabel(float tick, const QLocale &locale, QChar formatChar, int precision) Q_DECL_OVERRIDE;
  virtual QVector<float> createTickVector(float tickStep, const QCPRange &range) Q_DECL_OVERRIDE;
};
...
public:
  ...
  */
  ...
  // getters:
  float tickStep() const { return mTickStep; }
  ScaleStrategy scaleStrategy() const { return mScaleStrategy; }
  
  // setters:
  void setTickStep(float step);
...
public:
  ...
  // getters:
  QMap<float, QString> &ticks() { return mTicks; }
  int subTickCount() const { return mSubTickCount; }
  
  // setters:
  void setTicks(const QMap<float, QString> &ticks);
  void setTicks(const QVector<float> &positions, const QVector<QString> labels);
  void setSubTickCount(int subTicks);
  
  // non-virtual methods:
  void clear();
  void addTick(float position, QString label);
  void addTicks(const QMap<float, QString> &ticks);
  void addTicks(const QVector<float> &positions, const QVector<QString> &labels);
  
protected:
  // property members:
  QMap<float, QString> mTicks;
  int mSubTickCount;
...
public:
  ...
  */
  ...
  float piValue() const { return mPiValue; }
...
protected:
  ...
  // non-property members:
  float mPiTickStep; // size of one tick step in units of mPiValue
...
public:
  ...
  // getters:
  float logBase() const { return mLogBase; }
  int subTickCount() const { return mSubTickCount; }
  
  // setters:
  void setLogBase(float base);
  void setSubTickCount(int subTicks);
...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(float tickLabelRotation READ tickLabelRotation WRITE setTickLabelRotation)
  ...
  Q_PROPERTY(QVector<float> tickVector READ tickVector)
...
public:
  ...
  */
  ...
  float tickLabelRotation() const;
  LabelSide tickLabelSide() const;
  QString numberFormat() const;
  int numberPrecision() const { return mNumberPrecision; }
  QVector<float> tickVector() const { return mTickVector; }
  ...
  void setRange(float position, float size, Qt::AlignmentFlag alignment);
  void setRangeLower(float lower);
  void setRangeUpper(float upper);
  ...
  void setTickLabelRotation(float degrees);
  ...
  void moveRange(float diff);
  void scaleRange(float factor);
  void scaleRange(float factor, float center);
  void setScaleRatio(const QCPAxis *otherAxis, float ratio=1.0);
  void rescale(bool onlyVisiblePlottables=false);
  float pixelToCoord(float value) const;
  float coordToPixel(float value) const;
...
protected:
  ...
  bool mTickLabels;
  //float mTickLabelRotation; // in QCPAxisPainter
  ...
  QVector<float> mTickVector;
  QVector<QString> mTickVectorLabels;
  QVector<float> mSubTickVector;
...
public:
  ...
  float tickLabelRotation; // directly accessed by QCPAxis setters/getters
  ...
  float offset; // directly accessed by QCPAxis setters/getters
...
protected:
  ...
  virtual void placeTickLabel(QCPPainter *painter, float position, int distanceToAxis, const QString &text, QSize *tickLabelsSize);
  virtual void drawTickLabel(QCPPainter *painter, float x, float y, const TickLabelData &labelData) const;
...
public:
  ...
  */
  ...
  QCPScatterStyle();
  QCPScatterStyle(ScatterShape shape, float size=6);
  QCPScatterStyle(ScatterShape shape, const QColor &color, float size);
  QCPScatterStyle(ScatterShape shape, const QColor &color, const QColor &fill, float size);
  QCPScatterStyle(ScatterShape shape, const QPen &pen, const QBrush &brush, float size);
  QCPScatterStyle(const QPixmap &pixmap);
  QCPScatterStyle(const QPainterPath &customPath, const QPen &pen, const QBrush &brush=Qt::NoBrush, float size=6);
  ...
  void drawShape(QCPPainter *painter, float x, float y) const;
...
public:
  ...
  void removeBefore(float sortKey);
  void removeAfter(float sortKey);
  void remove(float sortKeyFrom, float sortKeyTo);
  void remove(float sortKey);
  void clear();
  void sort();
  ...
  const_iterator findBegin(float sortKey, bool expandedRange=true) const;
  const_iterator findEnd(float sortKey, bool expandedRange=true) const;
...
*/
template <class DataType>
void QCPDataContainer<DataType>::removeBefore(float sortKey)
{
...
*/
template <class DataType>
void QCPDataContainer<DataType>::removeAfter(float sortKey)
{
...
/*!
  ...
  data point with known (sort-)key, use \ref remove(float sortKey).
  
  \see removeBefore, removeAfter, clear
*/
template <class DataType>
void QCPDataContainer<DataType>::remove(float sortKeyFrom, float sortKeyTo)
{
...
/*! \overload
  ...
  precision, consider using \ref remove(float sortKeyFrom, float sortKeyTo) with a small
...
*/
template <class DataType>
void QCPDataContainer<DataType>::remove(float sortKey)
{
...
*/
template <class DataType>
typename QCPDataContainer<DataType>::const_iterator QCPDataContainer<DataType>::findBegin(float sortKey, bool expandedRange) const
{
  if (isEmpty())
    return constEnd();
...
*/
template <class DataType>
typename QCPDataContainer<DataType>::const_iterator QCPDataContainer<DataType>::findEnd(float sortKey, bool expandedRange) const
{
  if (isEmpty())
    return constEnd();
...
public:
  ...
  // introduced virtual methods:
  virtual float selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=0) const = 0;
  virtual QCPPlottableInterface1D *interface1D() { return 0; }
  virtual QCPRange getKeyRange(bool &foundRange, QCP::SignDomain inSignDomain=QCP::sdBoth) const = 0;
  virtual QCPRange getValueRange(bool &foundRange, QCP::SignDomain inSignDomain=QCP::sdBoth, const QCPRange &inKeyRange=QCPRange()) const = 0;
  
  // non-property methods:
  void coordsToPixels(float key, float value, float &x, float &y) const;
  const QPointF coordsToPixels(float key, float value) const;
  void pixelsToCoords(float x, float y, float &key, float &value) const;
  void pixelsToCoords(const QPointF &pixelPos, float &key, float &value) const;
...
public:
  ...
  */
  ...
  void setCoords(float key, float value);
...
public:
  ...
  // reimplemented virtual methods:
  virtual float selectTest(const QPointF &pos, bool onlySelectable, QVariant *details=0) const Q_DECL_OVERRIDE = 0;
...
protected:
  ...
  // non-virtual methods:
  float rectDistance(const QRectF &rect, const QPointF &pos, bool filledRect) const;
...
public:
  ...
  */
  ...
  float bufferDevicePixelRatio() const { return mBufferDevicePixelRatio; }
  ...
  void setBufferDevicePixelRatio(float ratio);
  ...
  bool savePng(const QString &fileName, int width=0, int height=0, float scale=1.0, int quality=-1, int resolution=96, QCP::ResolutionUnit resolutionUnit=QCP::ruDotsPerInch);
  bool saveJpg(const QString &fileName, int width=0, int height=0, float scale=1.0, int quality=-1, int resolution=96, QCP::ResolutionUnit resolutionUnit=QCP::ruDotsPerInch);
  bool saveBmp(const QString &fileName, int width=0, int height=0, float scale=1.0, int resolution=96, QCP::ResolutionUnit resolutionUnit=QCP::ruDotsPerInch);
  bool saveRastered(const QString &fileName, int width, int height, float scale, const char *format, int quality=-1, int resolution=96, QCP::ResolutionUnit resolutionUnit=QCP::ruDotsPerInch);
  QPixmap toPixmap(int width=0, int height=0, float scale=1.0);
...
public:
  ...
  virtual float dataMainKey(int index) const = 0;
  virtual float dataSortKey(int index) const = 0;
  virtual float dataMainValue(int index) const = 0;
  ...
  virtual int findBegin(float sortKey, bool expandedRange=true) const = 0;
  virtual int findEnd(float sortKey, bool expandedRange=true) const = 0;
};
...
public:
  ...
  virtual float dataMainKey(int index) const Q_DECL_OVERRIDE;
  virtual float dataSortKey(int index) const Q_DECL_OVERRIDE;
  virtual float dataMainValue(int index) const Q_DECL_OVERRIDE;
  virtual QCPRange dataValueRange(int index) const Q_DECL_OVERRIDE;
  virtual QPointF dataPixelPosition(int index) const Q_DECL_OVERRIDE;
  virtual bool sortKeyIsMainKey() const Q_DECL_OVERRIDE;
  virtual QCPDataSelection selectTestRect(const QRectF &rect, bool onlySelectable) const Q_DECL_OVERRIDE;
  virtual int findBegin(float sortKey, bool expandedRange=true) const Q_DECL_OVERRIDE;
  virtual int findEnd(float sortKey, bool expandedRange=true) const Q_DECL_OVERRIDE;
...
/*! \fn virtual float QCPPlottableInterface1D::dataMainKey(int index) const = 0
...
/*! \fn virtual float QCPPlottableInterface1D::dataSortKey(int index) const = 0
...
/*! \fn virtual float QCPPlottableInterface1D::dataMainValue(int index) const = 0
...
/*! \fn virtual int QCPPlottableInterface1D::findBegin(float sortKey, bool expandedRange) const = 0
...
/*! \fn virtual int QCPPlottableInterface1D::findEnd(float sortKey, bool expandedRange) const = 0
...
*/
template <class DataType>
float QCPAbstractPlottable1D<DataType>::dataMainKey(int index) const
{
...
*/
template <class DataType>
float QCPAbstractPlottable1D<DataType>::dataSortKey(int index) const
{
  if (index >= 0 && index < mDataContainer->size())
  {
...
*/
template <class DataType>
float QCPAbstractPlottable1D<DataType>::dataMainValue(int index) const
{
  if (index >= 0 && index < mDataContainer->size())
  {
...
*/
template <class DataType>
int QCPAbstractPlottable1D<DataType>::findBegin(float sortKey, bool expandedRange) const
{
...
*/
template <class DataType>
int QCPAbstractPlottable1D<DataType>::findEnd(float sortKey, bool expandedRange) const
{
...
*/
template <class DataType>
float QCPAbstractPlottable1D<DataType>::selectTest(const QPointF &pos, bool onlySelectable, QVariant *details) const
{
  if ((onlySelectable && mSelectable == QCP::stNone) || mDataContainer->isEmpty())
    return -1;
  if (!mKeyAxis || !mValueAxis)
  ...
  if (DataType::sortKeyIsMainKey()) // we can assume that data is sorted by main key, so can reduce the searched key interval:
  {
    ...
    float posKeyMin, posKeyMax, dummy;
  ...
  for (typename QCPDataContainer<DataType>::const_iterator it=begin; it!=end; ++it)
  {
    const float mainKey = it->mainKey();
    const float mainValue = it->mainValue();
    ...
    {
      const float currentDistSqr = QCPVector2D(coordsToPixels(mainKey, mainValue)-pos).lengthSquared();
...
public:
  ...
  */
  ...
  QMap<float, QColor> colorStops() const { return mColorStops; }
  ColorInterpolation colorInterpolation() const { return mColorInterpolation; }
  bool periodic() const { return mPeriodic; }
  
  // setters:
  void setLevelCount(int n);
  void setColorStops(const QMap<float, QColor> &colorStops);
  void setColorStopAt(float position, const QColor &color);
  void setColorInterpolation(ColorInterpolation interpolation);
  void setPeriodic(bool enabled);
  
  // non-property methods:
  void colorize(const float *data, const QCPRange &range, QRgb *scanLine, int n, int dataIndexFactor=1, bool logarithmic=false);
  void colorize(const float *data, const unsigned char *alpha, const QCPRange &range, QRgb *scanLine, int n, int dataIndexFactor=1, bool logarithmic=false);
  QRgb color(float position, const QCPRange &range, bool logarithmic=false);
...
protected:
  ...
  // non-virtual methods:
  float getTangentAngle(const QCPPlottableInterface1D *interface1d, int dataIndex, int direction) const;
...
public:
  ...
  float rangeZoomFactor(Qt::Orientation orientation);
  ...
  void setRangeZoomFactor(float horizontalFactor, float verticalFactor);
  void setRangeZoomFactor(float factor);
...
protected:
  ...
  float mRangeZoomFactorHorz, mRangeZoomFactorVert;
...
public:
  ...
  QCPTextElement(QCustomPlot *parentPlot, const QString &text, float pointSize);
  QCPTextElement(QCustomPlot *parentPlot, const QString &text, const QString &fontFamily, float pointSize);
...
signals:
  ...
  void floatClicked(QMouseEvent *event);
...
public:
  QCPGraphData();
  QCPGraphData(float key, float value);
  
  inline float sortKey() const { return key; }
  inline static QCPGraphData fromSortKey(float sortKey) { return QCPGraphData(sortKey, 0); }
  inline static bool sortKeyIsMainKey() { return true; }
  
  inline float mainKey() const { return key; }
  inline float mainValue() const { return value; }
...
protected:
  ...
  bool segmentsIntersect(float aLower, float aUpper, float bLower, float bUpper, int &bPrecedence) const;
  ...
  int findIndexBelowX(const QVector<QPointF> *data, float x) const;
  int findIndexAboveX(const QVector<QPointF> *data, float x) const;
  int findIndexBelowY(const QVector<QPointF> *data, float y) const;
  int findIndexAboveY(const QVector<QPointF> *data, float y) const;
  float pointDistance(const QPointF &pixelPoint, QCPGraphDataContainer::const_iterator &closestData) const;
...
public:
  QCPCurveData();
  QCPCurveData(float t, float key, float value);
  
  inline float sortKey() const { return t; }
  inline static QCPCurveData fromSortKey(float sortKey) { return QCPCurveData(sortKey, 0, 0); }
...
public:
  ...
  */
  ...
  void setData(const QVector<float> &t, const QVector<float> &keys, const QVector<float> &values, bool alreadySorted=false);
  ...
  // non-property methods:
  void addData(const QVector<float> &t, const QVector<float> &keys, const QVector<float> &values, bool alreadySorted=false);
  void addData(const QVector<float> &keys, const QVector<float> &values);
  void addData(float t, float key, float value);
  void addData(float key, float value);
...
protected:
  ...
  // non-virtual methods:
  void getCurveLines(QVector<QPointF> *lines, const QCPDataRange &dataRange, float penWidth) const;
  void getScatters(QVector<QPointF> *scatters, const QCPDataRange &dataRange, float scatterWidth) const;
  int getRegion(float key, float value, float keyMin, float valueMax, float keyMax, float valueMin) const;
  QPointF getOptimizedPoint(int prevRegion, float prevKey, float prevValue, float key, float value, float keyMin, float valueMax, float keyMax, float valueMin) const;
  QVector<QPointF> getOptimizedCornerPoints(int prevRegion, int currentRegion, float prevKey, float prevValue, float key, float value, float keyMin, float valueMax, float keyMax, float valueMin) const;
  bool mayTraverse(int prevRegion, int currentRegion) const;
  bool getTraverse(float prevKey, float prevValue, float key, float value, float keyMin, float valueMax, float keyMax, float valueMin, QPointF &crossA, QPointF &crossB) const;
  void getTraverseCornerPoints(int prevRegion, int currentRegion, float keyMin, float valueMax, float keyMax, float valueMin, QVector<QPointF> &beforeTraverse, QVector<QPointF> &afterTraverse) const;
  float pointDistance(const QPointF &pixelPoint, QCPCurveDataContainer::const_iterator &closestData) const;
...
protected:
  ...
  // virtual methods:
  float keyPixelOffset(const QCPBars *bars, float keyCoord);
  float getPixelSpacing(const QCPBars *bars, float keyCoord);
...
public:
  QCPBarsData();
  QCPBarsData(float key, float value);
  
  inline float sortKey() const { return key; }
  inline static QCPBarsData fromSortKey(float sortKey) { return QCPBarsData(sortKey, 0); }
  inline static bool sortKeyIsMainKey() { return true; } 
...
class QCP_LIB_DECL QCPBars : public QCPAbstractPlottable1D<QCPBarsData>
{
  ...
  Q_PROPERTY(float baseValue READ baseValue WRITE setBaseValue)
  Q_PROPERTY(float stackingGap READ stackingGap WRITE setStackingGap)
...
public:
  ...
  */
  ...
  float baseValue() const { return mBaseValue; }
  float stackingGap() const { return mStackingGap; }
  ...
  void setStackingGap(float pixels);
...
protected:
  ...
  QRectF getBarRect(float key, float value) const;
  void getPixelWidth(float key, float &lower, float &upper) const;
  float getStackedBaseValue(float key, bool positive) const;
...
public:
  ...
  QCPStatisticalBoxData(float key, float minimum, float lowerQuartile, float median, float upperQuartile, float maximum, const QVector<float>& outliers=QVector<float>());
  
  inline float sortKey() const { return key; }
  inline static QCPStatisticalBoxData fromSortKey(float sortKey) { return QCPStatisticalBoxData(sortKey, 0, 0, 0, 0, 0); }
  inline static bool sortKeyIsMainKey() { return true; }
  
  inline float mainKey() const { return key; }
  inline float mainValue() const { return median; }
  
  inline QCPRange valueRange() const
  {
    QCPRange result(minimum, maximum);
    for (QVector<float>::const_iterator it = outliers.constBegin(); it != outliers.constEnd(); ++it)
      result.expand(*it);
    return result;
  }
  
  float key, minimum, lowerQuartile, median, upperQuartile, maximum;
...
class QCP_LIB_DECL QCPStatisticalBox : public QCPAbstractPlottable1D<QCPStatisticalBoxData>
{
  ...
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(float width READ width WRITE setWidth)
  Q_PROPERTY(float whiskerWidth READ whiskerWidth WRITE setWhiskerWidth)
...
public:
  ...
  float width() const { return mWidth; }
  float whiskerWidth() const { return mWhiskerWidth; }
  ...
  void setData(const QVector<float> &keys, const QVector<float> &minimum, const QVector<float> &lowerQuartile, const QVector<float> &median, const QVector<float> &upperQuartile, const QVector<float> &maximum, bool alreadySorted=false);
  void setWidth(float width);
  void setWhiskerWidth(float width);
  ...
  // non-property methods:
  void addData(const QVector<float> &keys, const QVector<float> &minimum, const QVector<float> &lowerQuartile, const QVector<float> &median, const QVector<float> &upperQuartile, const QVector<float> &maximum, bool alreadySorted=false);
  void addData(float key, float minimum, float lowerQuartile, float median, float upperQuartile, float maximum, const QVector<float> &outliers=QVector<float>());
...
public:
  ...
  void SetDataBounds(float lower, float upper)
  {
  ...
  float data(float key, float value);
  float cell(int keyIndex, int valueIndex);
  ...
  void setData(float key, float value, float z);
  void setCell(int keyIndex, int valueIndex, float z);
  void setAlpha(int keyIndex, int valueIndex, unsigned char alpha);
  
  //smhzc
  float *GetDataPtr(){return mData;}
  ...
  void coordToCell(float key, float value, int *keyIndex, int *valueIndex) const;
  void cellToCoord(int keyIndex, int valueIndex, float *key, float *value) const;
...
public:
  QCPFinancialData();
  QCPFinancialData(float key, float open, float high, float low, float close);
  
  inline float sortKey() const { return key; }
  inline static QCPFinancialData fromSortKey(float sortKey) { return QCPFinancialData(sortKey, 0, 0, 0, 0); }
  inline static bool sortKeyIsMainKey() { return true; } 
  
  inline float mainKey() const { return key; }
  inline float mainValue() const { return open; }
...
public:
  ...
  */
  ...
  void setData(const QVector<float> &keys, const QVector<float> &open, const QVector<float> &high, const QVector<float> &low, const QVector<float> &close, bool alreadySorted=false);
  ...
  // non-property methods:
  void addData(const QVector<float> &keys, const QVector<float> &open, const QVector<float> &high, const QVector<float> &low, const QVector<float> &close, bool alreadySorted=false);
  void addData(float key, float open, float high, float low, float close);
  ...
  // static methods:
  static QCPFinancialDataContainer timeSeriesToOhlc(const QVector<float> &time, const QVector<float> &value, float timeBinSize, float timeBinOffset = 0);
...
protected:
  ...
  float getPixelWidth(float key, float keyPixel) const;
  float ohlcSelectTest(const QPointF &pos, const QCPFinancialDataContainer::const_iterator &begin, const QCPFinancialDataContainer::const_iterator &end, QCPFinancialDataContainer::const_iterator &closestDataPoint) const;
  float candlestickSelectTest(const QPointF &pos, const QCPFinancialDataContainer::const_iterator &begin, const QCPFinancialDataContainer::const_iterator &end, QCPFinancialDataContainer::const_iterator &closestDataPoint) const;
...
public:
  QCPErrorBarsData();
  explicit QCPErrorBarsData(float error);
  QCPErrorBarsData(float errorMinus, float errorPlus);
  
  float errorMinus, errorPlus;
};
...
class QCP_LIB_DECL QCPErrorBars : public QCPAbstractPlottable, public QCPPlottableInterface1D
{
  ...
  Q_PROPERTY(float whiskerWidth READ whiskerWidth WRITE setWhiskerWidth)
  Q_PROPERTY(float symbolGap READ symbolGap WRITE setSymbolGap)
  /// \endcond
public:
  ...
  */
  ...
  float whiskerWidth() const { return mWhiskerWidth; }
  float symbolGap() const { return mSymbolGap; }
  
  // setters:
  void setData(QSharedPointer<QCPErrorBarsDataContainer> data);
  void setData(const QVector<float> &error);
  void setData(const QVector<float> &errorMinus, const QVector<float> &errorPlus);
  void setDataPlottable(QCPAbstractPlottable* plottable);
  void setErrorType(ErrorType type);
  void setWhiskerWidth(float pixels);
  void setSymbolGap(float pixels);
  
  // non-property methods:
  void addData(const QVector<float> &error);
  void addData(const QVector<float> &errorMinus, const QVector<float> &errorPlus);
  void addData(float error);
  void addData(float errorMinus, float errorPlus);
...
protected:
  ...
  float pointDistance(const QPointF &pixelPoint, QCPErrorBarsDataContainer::const_iterator &closestData) const;
  // helpers:
  void getDataSegments(QList<QCPDataRange> &selectedSegments, QList<QCPDataRange> &unselectedSegments) const;
...
class QCP_LIB_DECL QCPItemTracer : public QCPAbstractItem
{
  ...
  Q_PROPERTY(float graphKey READ graphKey WRITE setGraphKey)
...
public:
  ...
  */
  ...
  float graphKey() const { return mGraphKey; }
